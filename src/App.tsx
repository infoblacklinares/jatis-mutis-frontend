...
function ProtectedDashboard() {
  ...
  return <div className="dashboard"><Sidebar currentView={currentView} onNavigate={setCurrentView} /><main className="main-content"><header className="topbar"><div><p className="eyebrow">{view.eyebrow}</p><h1>{view.title}</h1></div><UserButton /></header>{view.component}</main></div>;
}
