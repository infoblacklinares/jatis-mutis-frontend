...
export function Products() {
  ...
  return <section className="panel full-panel">
    ...
    {apiError && <div className="status warning"><strong>No se pudo conectar con Shopify.</strong><br /><span className="muted">{apiError}</span><br /><span className="muted">Los datos mostrados son locales.</span></div>}
