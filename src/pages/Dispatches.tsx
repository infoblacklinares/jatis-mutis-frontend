...
export function Dispatches() {
  const [dispatches, setDispatches] = useState<Dispatch[]>(() => { try { return JSON.parse(localStorage.getItem("jm_dispatches") || "null") || initial; } catch { return initial; } });
