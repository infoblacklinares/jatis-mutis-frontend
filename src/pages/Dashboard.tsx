...
export function Dashboard() {
  ...
  const periodOrders = orders.filter((order) => { const time = Date.parse(order.date); return !Number.isNaN(time) ? time >= cutoff : true; });
  ...
  return <>
    <div className="dashboard-search"><span aria-hidden="true">⌕</span><input aria-label="Buscar en el panel" placeholder="Buscar producto, pedido o cliente..." /><kbd>Ctrl + K</kbd></div>
